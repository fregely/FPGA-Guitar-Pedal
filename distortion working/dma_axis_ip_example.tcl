...
\
  ...
  # Create instance: pedal_top_0, and set properties
  set pedal_top_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:pedal_top:1.0 pedal_top_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net axi_dma_M_AXIS_MM2S [get_bd_intf_pins axi_dma/M_AXIS_MM2S] [get_bd_intf_pins pedal_top_0/in_stream]
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports switches] [get_bd_intf_pins axi_gpio_0/GPIO]
  ...
  connect_bd_intf_net -intf_net pedal_top_0_out_stream [get_bd_intf_pins pedal_top_0/out_stream] [get_bd_intf_pins axi_dma/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins ps7_0_axi_periph/M04_AXI] [get_bd_intf_pins pedal_top_0/s_axi_ctrl]
  ...
  assign_bd_address -offset 0xA0030000 -range 0x00010000 -with_name SEG_pedal_top_0_Reg_1 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs pedal_top_0/s_axi_ctrl/Reg] -force
