...
xilinx.com:hls:audio_passthrough:1.0\
...
\
  ...
  set_property -dict [list \
    CONFIG.CLKOUT1_JITTER {299.507} \
    CONFIG.CLKOUT1_PHASE_ERROR {189.550} \
    CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {11.2896} \
    CONFIG.MMCM_CLKFBOUT_MULT_F {31.625} \
    CONFIG.MMCM_CLKOUT0_DIVIDE_F {93.375} \
    CONFIG.MMCM_DIVCLK_DIVIDE {3} \
  ] $clk_wiz_0


  # Create instance: audio_passthrough_0, and set properties
  set audio_passthrough_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:audio_passthrough:1.0 audio_passthrough_0 ]
  ...
  connect_bd_intf_net -intf_net audio_passthrough_0_out_stream [get_bd_intf_pins audio_passthrough_0/out_stream] [get_bd_intf_pins axis_data_fifo_0/S_AXIS]
  connect_bd_intf_net -intf_net axi_dma_M_AXIS_MM2S [get_bd_intf_pins audio_passthrough_0/in_stream] [get_bd_intf_pins axi_dma/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net axis_broadcaster_0_M00_AXIS [get_bd_intf_pins axis_broadcaster_0/M00_AXIS] [get_bd_intf_pins axi_dma/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net axis_broadcaster_0_M01_AXIS [get_bd_intf_pins i2s_transmitter_0/s_axis_aud] [get_bd_intf_pins axis_broadcaster_0/M01_AXIS]
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins axis_data_fifo_0/M_AXIS] [get_bd_intf_pins axis_broadcaster_0/S_AXIS]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins audio_passthrough_0/s_axi_control]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins ps7_0_axi_periph/M02_AXI] [get_bd_intf_pins i2s_transmitter_0/s_axi_ctrl]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_ports clk_out1_0] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins i2s_transmitter_0/aud_mclk]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_ports locked_0] [get_bd_pins proc_sys_reset_0/dcm_locked]
  connect_bd_net -net i2s_transmitter_0_irq [get_bd_pins i2s_transmitter_0/irq] [get_bd_ports irq_0]
  connect_bd_net -net i2s_transmitter_0_lrclk_out [get_bd_pins i2s_transmitter_0/lrclk_out] [get_bd_ports lrclk_out_0]
  connect_bd_net -net i2s_transmitter_0_sclk_out [get_bd_pins i2s_transmitter_0/sclk_out] [get_bd_ports sclk_out_0]
  connect_bd_net -net i2s_transmitter_0_sdata_0_out [get_bd_pins i2s_transmitter_0/sdata_0_out] [get_bd_ports sdata_0_out_0]
  connect_bd_net -net proc_sys_reset_0_peripheral_reset [get_bd_pins proc_sys_reset_0/peripheral_reset] [get_bd_pins i2s_transmitter_0/aud_mrst]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins axi_dma/axi_resetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon_1/ARESETN] [get_bd_pins axi_mem_intercon_1/M00_ARESETN] [get_bd_pins axi_mem_intercon_1/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins i2s_transmitter_0/s_axi_ctrl_aresetn] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins i2s_transmitter_0/s_axis_aud_aresetn] [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins util_vector_logic_0/Op1] [get_bd_pins axis_broadcaster_0/aresetn] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins audio_passthrough_0/ap_rst_n]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins util_vector_logic_0/Res] [get_bd_pins clk_wiz_0/reset]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconstant_0/dout] [get_bd_ports AIC_nRST]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins axi_dma/m_axi_mm2s_aclk] [get_bd_pins axi_dma/m_axi_s2mm_aclk] [get_bd_pins axi_dma/s_axi_lite_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon_1/ACLK] [get_bd_pins axi_mem_intercon_1/M00_ACLK] [get_bd_pins axi_mem_intercon_1/S00_ACLK] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp2_fpd_aclk] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins i2s_transmitter_0/s_axi_ctrl_aclk] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins i2s_transmitter_0/s_axis_aud_aclk] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins audio_passthrough_0/ap_clk]
  ...
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs audio_passthrough_0/s_axi_control/Reg] -force
  ...
  assign_bd_address -offset 0xA0010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs i2s_transmitter_0/s_axi_ctrl/Reg] -force
