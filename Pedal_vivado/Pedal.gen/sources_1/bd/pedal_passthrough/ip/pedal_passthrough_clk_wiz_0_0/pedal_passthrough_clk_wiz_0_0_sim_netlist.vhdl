...
-- Date        : Thu Mar 12 10:43:45 2026
-- Host        : Theodore running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               d:/FPGA-Guitar-Pedal/Pedal_vivado/Pedal.gen/sources_1/bd/pedal_passthrough/ip/pedal_passthrough_clk_wiz_0_0/pedal_passthrough_clk_wiz_0_0_sim_netlist.vhdl
...
entity pedal_passthrough_clk_wiz_0_0_clk_wiz is
  port (
...
end pedal_passthrough_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of pedal_passthrough_clk_wiz_0_0_clk_wiz is
  signal clk_in1_pedal_passthrough_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_pedal_passthrough_clk_wiz_0_0 : STD_LOGIC;
...
clkin1_ibuf: unisim.vcomponents.IBUF
    generic map(
      IOSTANDARD => "DEFAULT"
        ...
        port map (
      I => clk_in1,
      O => clk_in1_pedal_passthrough_clk_wiz_0_0
    );
clkout1_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out1_pedal_passthrough_clk_wiz_0_0,
      O => clk_out1
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKIN1 => clk_in1_pedal_passthrough_clk_wiz_0_0,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKINSTOPPED => NLW_mmcme4_adv_inst_CLKINSTOPPED_UNCONNECTED,
      CLKOUT0 => clk_out1_pedal_passthrough_clk_wiz_0_0,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity pedal_passthrough_clk_wiz_0_0 is
  port (
    clk_out1 : out STD_LOGIC;
    reset : in STD_LOGIC;
    locked : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of pedal_passthrough_clk_wiz_0_0 : entity is true;
end pedal_passthrough_clk_wiz_0_0;

architecture STRUCTURE of pedal_passthrough_clk_wiz_0_0 is
begin
inst: entity work.pedal_passthrough_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1 => clk_in1,
      clk_out1 => clk_out1,
      locked => locked,
