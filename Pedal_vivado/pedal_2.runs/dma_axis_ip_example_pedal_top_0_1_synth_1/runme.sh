...
HD_PWD='E:/FPGA-Guitar-Pedal/pedal_vivado/pedal_2.runs/dma_axis_ip_example_pedal_top_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_axis_ip_example_pedal_top_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_axis_ip_example_pedal_top_0_1.tcl
