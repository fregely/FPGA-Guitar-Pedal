...
HD_PWD='E:/FPGA-Guitar-Pedal/pedal_2/pedal_2.runs/dma_axis_ip_example_util_vector_logic_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dma_axis_ip_example_util_vector_logic_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_axis_ip_example_util_vector_logic_0_0.tcl
