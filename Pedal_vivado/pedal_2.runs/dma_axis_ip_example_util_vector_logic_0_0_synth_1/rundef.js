...
ISEStep( "vivado",
         "-log dma_axis_ip_example_util_vector_logic_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dma_axis_ip_example_util_vector_logic_0_0.tcl" );
